...
The first step is to display a list of shifts with the CLOSED status, find the record that needs to be updated, and then make a note of the ID number. Viewing specific a shift record requires the `GET` method.
